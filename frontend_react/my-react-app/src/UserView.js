...
function UserView() {
  // Datos del usuario de ejemplo (reemplazar con datos reales)
  const user = {
    firstName: 'John',
    lastName: 'Doe',
    email: 'john.doe@example.com',
    profileImage: sample3, // Reemplazar con la ruta real de la imagen
  };

  // Datos de PDF favoritos de ejemplo (reemplazar con datos reales)
  const favoritePDFs = [
    {
      title: 'PDF 1',
      url: '/path/to/pdf1.pdf',
